...
echo 'iptables -A INPUT -p tcp -m multiport --destination-ports 22,8080,655 -j ACCEPT' >>/root/iptables.sh
...
echo 'ip6tables -A INPUT -p tcp -m multiport --destination-ports 22,8080,655 -j ACCEPT' >>/root/iptables.sh
